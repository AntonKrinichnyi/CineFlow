...
Revision ID: d7e068817220
Revises: 
Create Date: 2025-05-06 22:59:50.091227
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.Enum('USER', 'MODERATOR', 'ADMIN', name='usergroupsenum'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    op.create_table('passwrod_reset_token',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('token', sa.String(length=64), nullable=False),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    sa.Column('gender', sa.Enum('MAN', 'WOMAN', name='usergenderenum'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table('passwrod_reset_token')
